...
const fetchCourseData = (courseName, courseNum, onSuccess, onError) => {
  const courseURL = `https://www.sfu.ca/bin/wcm/course-outlines?2025/fall/${courseName}/${courseNum}`;
...
const fetchDetails = async (courseName, courseNum, value) => {
  const url = `https://www.sfu.ca/bin/wcm/course-outlines?2025/fall/${courseName}/${courseNum}/${value}`;
